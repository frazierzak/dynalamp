...
*/ 
	...
	{    
		0 = [] spawn 
		{   
			hintsilent "TPWCAS 4.5 Starting...";    
			sleep 3;    
			hintsilent "";
		};
	};
	
	diag_log format ["%1 - TPWCAS 4.5 Initiated - tpwcas_mode: [%2]", time, tpwcas_mode];    
	...
	{   
		...
		{  
			//DISABLE REVEAL
			tpwcas_reveal = 0;
			diag_log format ["%1 - TPWCAS supported version of ASR_AI found", time];    
		};      
	};		
	...
	call compile preprocessFileLineNumbers "scripts\tpwcas\tpwcas_debug.sqf"; //visual debugging

	//if ( tpwcas_mode <= 2 ) then  // not used for server only or Headless client mode
	//{
		call compile preprocessFileLineNumbers "scripts\tpwcas\tpwcas_client_debug.sqf"; //visual debugging
		//call compile preprocessFileLineNumbers "scripts\tpwcas\tpwcas_textdebug.sqf"; //text debugging => DEPRECATED
		call compile preprocessFileLineNumbers "scripts\tpwcas\tpwcas_visuals.sqf"; //player suppression visuals
	//};
	
	call compile preprocessFileLineNumbers "scripts\tpwcas\tpwcas_decskill.sqf"; //decrease AI skills
	call compile preprocessFileLineNumbers "scripts\tpwcas\tpwcas_incskill.sqf"; //increase AI skills
	call compile preprocessFileLineNumbers "scripts\tpwcas\tpwcas_supstate.sqf"; //bdetect callback to assign unit suppression status
	call compile preprocessFileLineNumbers "scripts\tpwcas\tpwcas_getcover.sqf"; //move suppressed unit into cover
	call compile preprocessFileLineNumbers "scripts\tpwcas\tpwcas_runforit.sqf"; //civilians will run away from the shooting

	call compile preprocessFileLineNumbers "scripts\tpwcas\tpwcas_mainloop.sqf"; //main loop
	
	//////////////
	//CALL BDETECT
	////////////// 

	call compile preprocessFileLineNumbers "scripts\tpwcas\tpwcas_bdetect.sqf"; //bullet detection
	...
	{
		call compile preprocessFileLineNumbers "scripts\tpwcas\tpwcas_los.sqf"; //tpw los main loop
		
		// Run day/night determination
		[] execVm "scripts\tpwcas\tpwcas_los_sunangle.sqf"; //determine day or night
	...
	{    
		0 = [] spawn 
		{   
			hintsilent "TPWCAS 4.5 Active";    
			sleep 3;    
			hintsilent "";
		};
	};
	
	diag_log format ["%1 - TPWCAS 4.5 Active - tpwcas_mode: [%2]", time, tpwcas_mode];  
